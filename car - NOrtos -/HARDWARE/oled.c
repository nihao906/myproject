...
#include "oledfont.h"  	 
#include "delay.h"
#include "BITBAND.h" //HUISIWEN

void GPIO_setoledmode(GPIOMode_TypeDef mode)//HUISIWEN
{
...
void IIC_Start()
{
  GPIO_setoledmode(GPIO_Mode_OUT);
	PBout(8) = 1;//SCL
	PBout(9) = 1;//SDA
	DElAY_us(5);//100KHZ = 1/100MS = 10US 
