...
{
    uint32_t rotpk[8];
    uint32_t secure_counter1[2];
    uint32_t secure_version;

    drvEfuseReadWriteOp_t efuse_ops[] = {
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_0, {.rval = &rotpk[0]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_1, {.rval = &rotpk[1]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_2, {.rval = &rotpk[2]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_3, {.rval = &rotpk[3]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_4, {.rval = &rotpk[4]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_5, {.rval = &rotpk[5]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_6, {.rval = &rotpk[6]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_ROTPK_7, {.rval = &rotpk[7]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_SECURE_COUNTER1_0, {.rval = &secure_counter1[0]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_SECURE_COUNTER1_1, {.rval = &secure_counter1[1]}},
    };
    if (!drvEfuseReadWrite(efuse_ops, OSI_ARRAY_SIZE(efuse_ops)))
    {
        OSI_LOGI(0x10009104, "efuse read failed");
    ...
    secure_version = halFromEfuseAntiRollback64(secure_counter1);
    bool result = simageSignVerify((simageHeader_t *)header, (osiBits256_t *)rotpk, 0, secure_version);
    return result;
}
#endif
