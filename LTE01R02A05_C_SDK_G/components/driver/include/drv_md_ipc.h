...
/**
 * IPC IP PACKT CONFIG NUMBER
 */
struct ip_packet_number_t
{
    uint32_t ul_big_ps_buf_cut;
    uint32_t ul_lit_ps_buf_cnt;
    uint32_t dl_big_ps_buf_cut;
    uint32_t dl_lit_ps_buf_cnt;
};
