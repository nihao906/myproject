...
/*MAIN_RI    	*/{  20,     1,          0,        GPIO_1,    GPIO_OUTPUT,       QUEC_PIN_NONE,    LVL_HIGH,         &hwp_iomux->gpio_1,          &hwp_iomux->pad_gpio_1,   		4},
...
/*MAIN_DTR	 	*/{  19 ,		 0,			  	 0,		   GPIO_4,    QUEC_PIN_NONE,	     QUEC_PIN_NONE,          QUEC_PIN_NONE,	 &hwp_iomux->gpio_4, 		  &hwp_iomux->pad_gpio_4,			4},
/*GPIO6	      */{  28,		 0,			  	 0,		   GPIO_6,    QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_6,	      &hwp_iomux->pad_gpio_6,    		4},
/*GPIO7	      */{  29 ,		 0,			  	 0,		   GPIO_7,    QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_7, 		  &hwp_iomux->pad_gpio_7,			4},
...
/*UART2_TXD   */{  23,		 3,			  	 1,		   GPIO_14,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->uart_1_cts,	  &hwp_iomux->pad_uart_1_cts,    	4},
/*UART2_RXD 	*/{  22 ,		 3,			  	 4,		   GPIO_15,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->uart_1_rts, 	  &hwp_iomux->pad_uart_1_rts,		4},
...
/*GPIO18	    */{  80 ,		 2,			  	 2,		   GPIO_18,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->spi_camera_sck,  &hwp_iomux->pad_spi_camera_sck,	2},
/*SPI2_CLK    */{  101,		 2, 			   0, 	   GPIO_18,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_18,		  &hwp_iomux->pad_gpio_18,			2},
/*PCM_CLK		  */{  30 ,		 0, 			   2, 	   GPIO_19,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->i2s1_bck,		  &hwp_iomux->pad_i2s1_bck,			2},
/*SPI2_CS	    */{  79,		 2,			     0,		   GPIO_19,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_19,	      &hwp_iomux->pad_gpio_19,			2},
/*PCM_SYNC	 	*/{  31,		 0,			     2,		   GPIO_20,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->i2s1_lrck,	      &hwp_iomux->pad_i2s1_lrck,		2},
/*SPI2_DIO0   */{  100 ,	 2,			 	   0,		   GPIO_20,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,	   QUEC_PIN_NONE,	 &hwp_iomux->gpio_20, 		  &hwp_iomux->pad_gpio_20,			2},
/*PCM_IN		  */{  32,		 0, 			   2, 	   GPIO_21,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->i2s_sdat_i,	  &hwp_iomux->pad_i2s_sdat_i,		2},
/*SPI2_DI_1   */{  108,		 2,			 	   0,		   GPIO_21,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_21,         &hwp_iomux->pad_gpio_21, 			2},
/*PCM_OUT		  */{  33 ,		 0, 			   2, 	   GPIO_22,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->i2s1_sdat_o,	  &hwp_iomux->pad_i2s1_sdat_o,		2},
/*GPIO_22     */{  109,		 0,			 	   0,		   GPIO_22,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_22,		  &hwp_iomux->pad_gpio_22,			2},
/*GPIO_23     */{  107,		 0,			 	   0,		   GPIO_23,   QUEC_PIN_NONE,	 QUEC_PIN_NONE,    QUEC_PIN_NONE,	 &hwp_iomux->gpio_23, 	      &hwp_iomux->pad_gpio_23,			2},
/*GPIO_24     */{  5  ,    1,       1,        GPIO_24,   GPIO_INPUT,        PULL_UP,          QUEC_PIN_NONE,    &hwp_iomux->sw_clk,          &hwp_iomux->pad_sw_clk,           2},
/*GPIO_25     */{  6  ,    1,       1,        GPIO_25,   GPIO_INPUT,        PULL_UP,          QUEC_PIN_NONE,    &hwp_iomux->sw_dio,          &hwp_iomux->pad_sw_dio,           2},
...
/*GPIO_33    	*/{  38 ,    1,       1,        GPIO_33,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->uart_2_cts,      &hwp_iomux->pad_uart_2_cts,       2},
/*KEYOUT_1   	*/{  86 ,    0,       1,        GPIO_33,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->keyout_1,        &hwp_iomux->pad_keyout_1, 		4},
/*GPIO_34    	*/{  39 ,    1,       1,        GPIO_34,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->uart_2_rts,      &hwp_iomux->pad_uart_2_rts,       2},
...
/*GPIO_44   	*/{  103 ,   3,       3,        GPIO_44,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->camera_rst_l,    &hwp_iomux->pad_camera_rst_l, 	2},
/*GPIO_45   	*/{  81 ,    3,       3,        GPIO_45,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->camera_pwdn,     &hwp_iomux->pad_camera_pwdn, 		2},
/*PCM_MCLK    */{  26 ,    0,       1,        GPIO_46,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->i2s1_mclk,       &hwp_iomux->pad_i2s1_mclk,        2},
/*GPIO_46   	*/{  54 ,    2,       2,        GPIO_46,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->camera_ref_clk,  &hwp_iomux->pad_camera_ref_clk, 	2},
/*GPIO_47	    */{  55 ,    3,       3,        GPIO_47,   QUEC_PIN_NONE,     QUEC_PIN_NONE,    QUEC_PIN_NONE,    &hwp_iomux->spi_camera_si_0, &hwp_iomux->pad_spi_camera_si_0,	2},
