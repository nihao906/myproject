...
const ql_band_size_s ql_band_size =
   /*  gsm_size    lte_size  */
    ...
    {     0,          5     };
#elif defined(CONFIG_QL_PROJECT_DEF_EC600G_EU_LD) || defined(CONFIG_QL_PROJECT_DEF_EG915G_EU_GD) || defined(CONFIG_QL_PROJECT_DEF_EC600G_EU_LC)
    {     0,          10    };
#elif defined(CONFIG_QL_PROJECT_DEF_EG800G_LA_LD) || defined(CONFIG_QL_PROJECT_DEF_EC600G_LA_LD)
    {     0,          8     };
#else
    {     0,          9     };
#endif
...
#if defined(CONFIG_QL_PROJECT_DEF_EG800G_LA_LD) || defined(CONFIG_QL_PROJECT_DEF_EC600G_LA_LD)
    {  1  };
#else
    {  0  };
#endif
...
/*** 194M ***/
#if defined(CONFIG_QL_PROJECT_DEF_EC600G_EU_LD) || defined(CONFIG_QL_PROJECT_DEF_EG915G_EU_GD) || defined(CONFIG_QL_PROJECT_DEF_EC600G_EU_LC)
