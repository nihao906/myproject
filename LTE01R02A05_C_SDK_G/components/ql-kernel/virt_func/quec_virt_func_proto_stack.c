...
__attribute__((weak)) int mbedtls_ssl_resend( mbedtls_ssl_context *ssl )
{
    return 0;
}
...
__attribute__((weak)) int mbedtls_ssl_conf_alpn_protocols( mbedtls_ssl_config *conf, const char **protos )
{
    return 0;
}

__attribute__((weak)) int mbedtls_timing_get_delay( void *data )
{
    return 0;
}

__attribute__((weak)) void mbedtls_timing_set_delay( void *data, uint32_t int_ms, uint32_t fin_ms )
{
    return ;
}

__attribute__((weak)) int mbedtls_ssl_conf_psk( mbedtls_ssl_config *conf,
...
__attribute__((weak)) void mbedtls_ssl_set_mtu( mbedtls_ssl_context *ssl, uint16_t mtu )
{
    return ;
}
#endif
...
__attribute__((weak)) uint8_t* ql_clat_6to4(struct netif *inp_netif, uint8_t *ip6_packet, int packet_length, int* convert_length)
{
    return NULL;
}
__attribute__((weak)) uint8_t* ql_clat_4to6(uint8_t *ip_packet, int packet_length, struct xlat_netif *Intf)
{
    return NULL;
}
__attribute__((weak)) int ql_xlat_clat_enable(void)
{
    return 0;
}
__attribute__((weak)) int ql_xlat_get_enable(int *code)
{
    return 0;
}
__attribute__((weak)) void ql_xlat_set_enable(int value)
{
    return;
}
__attribute__((weak)) int ql_clat_set_dns_ipv4_addr(uint8_t nSim, int profile_idx, ip4_addr_t *new_dns, ip4_addr_t *new_ipv4)
{
    return 0;
}
#endif