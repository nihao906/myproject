...
#else
//QUEC_BOOT_V_SD 电压域复位默认为3.2V,所以最好只用于支持3.2V电压的flash
              /*                reg                           func     power_domain            power val              pad reg                    drv_val  */ 
/*SPI_2_CLK  */{  &hwp_iomux->sdmmc1_data_2            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_2 ,     4  },
/*SPI_2_CS   */{  &hwp_iomux->sdmmc1_data_3            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_3 ,     4  },
/*SPI_2_SIO0 */{  &hwp_iomux->sdmmc1_data_4            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_4 ,     4  },
/*SPI_2_SIO1 */{  &hwp_iomux->sdmmc1_data_5            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_5 ,     4  },
/*SPI_2_SIO2 */{  &hwp_iomux->sdmmc1_data_6            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_6 ,     4  },
/*SPI_2_SIO3 */{  &hwp_iomux->sdmmc1_data_7            ,       6 ,   QUEC_BOOT_V_SD  ,  POWER_LEVEL_3200MV   ,  &hwp_iomux->pad_sdmmc1_data_7 ,     4  },
#endif
