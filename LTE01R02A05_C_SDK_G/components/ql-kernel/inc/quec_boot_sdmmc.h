...
* Description: 第一路sdmmc:初始化sd驱动并挂载只读文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
* Description: 第一路sdmmc:初始化emmc驱动并挂载只读文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
* Description: 第一路sdmmc:初始化emmc驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
...
* Description: 第一路sdmmc:初始化emmc驱动并挂载可读写文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
/*****************************************************************
* Function: quec_boot_sdmmc2_init
* Description: 第二路sdmmc:初始化sd驱动并挂载只读文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
/*****************************************************************
* Function: quec_boot_sdmmc2_destroy与quec_boot_sdmmc2_close功能一样
* Description: 第二路sdmmc:关闭sd驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
...
/*****************************************************************
* Function: quec_boot_sdmmc2_open
* Description: 第二路sdmmc:初始化sd驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
*****************************************************************/
extern int quec_boot_sdmmc2_open(void);

/*****************************************************************
* Function: quec_boot_sdmmc2_close
* Description: 第二路sdmmc:关闭sd驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
*****************************************************************/
extern int quec_boot_sdmmc2_close(void);

/*****************************************************************
* Function: quec_boot_sdmmc2_read
* Description: 一次只能读一个扇区
* Parameters:
*   nr            [in]  扇区号
*   offset        [in]  数据相对扇区开始的偏移
...
*      负值,failure
*****************************************************************/
extern int quec_boot_sdmmc2_read(uint64_t nr, unsigned int offset, int size, void *data);

/*****************************************************************
* Function: quec_boot_sdmmc2_write
* Description: 一次可以写一个或者多个扇区
* Parameters:
*   nr            [in]  扇区号
*   count         [in]  扇区个数
...
*     负值，failure
*****************************************************************/
extern int quec_boot_sdmmc2_write(uint64_t nr,int count,const void *data);

#ifdef CONFIG_QUEC_PROJECT_FEATURE_BOOT_FAT_RW
/*****************************************************************
* Function: quec_boot_sdmmc2_init_ex
* Description: 第二路sdmmc:初始化sd驱动并挂载可读写文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
/*****************************************************************
* Function: quec_boot_emmc2_init
* Description: 第二路sdmmc:初始化emmc驱动并挂载只读文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
...
/*****************************************************************
* Function: quec_boot_emmc2_destroy与quec_boot_emmc2_close功能一样
* Description: 第二路sdmmc:关闭sd驱动
* Parameters:	void
* Return:
*     0        succeed
...
/*****************************************************************
* Function: quec_boot_emmc_open
* Description: 第二路sdmmc:初始化emmc驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
*****************************************************************/
extern int quec_boot_emmc2_open(void);

/*****************************************************************
* Function: quec_boot_emmc2_close
* Description: 第二路sdmmc:关闭emmc驱动
* Parameters:	void
* Return:
*     0        succeed
*     OTHER    failure
*****************************************************************/
extern int quec_boot_emmc2_close(void);

/*****************************************************************
* Function: quec_boot_emmc2_read
* Description: 一次只能读一个扇区
* Parameters:
*   nr            [in]  扇区号
*   offset        [in]  数据相对扇区开始的偏移
...
*      负值,failure
*****************************************************************/
extern int quec_boot_emmc2_read(uint64_t nr, unsigned int offset, int size, void *data);

/*****************************************************************
* Function: quec_boot_emmc2_write
* Description: 一次可以写一个或者多个扇区
* Parameters:
*   nr            [in]  扇区号
*   count         [in]  扇区个数
...
*     负值，failure
*****************************************************************/
extern int quec_boot_emmc2_write(uint64_t nr,int count,const void *data);

#ifdef CONFIG_QUEC_PROJECT_FEATURE_BOOT_FAT_RW
/*****************************************************************
* Function: quec_boot_emmc2_init_ex
* Description: 第二路sdmmc:初始化emmc驱动并挂载可读写文件系统
* Parameters:
*   pt            [in]  分区号
* Return:
*     0        succeed
