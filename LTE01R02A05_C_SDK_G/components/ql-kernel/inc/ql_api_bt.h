...
#define QL_BLE_SEND_DATA_MAX_SIZE           517
...
typedef enum 
{
    QL_BT_BLE_POWER,                                            //调整BLE发射功率支持范围[0dBm,10dBm]
}ql_bt_power_type_e;

typedef enum 
{
    QL_BT_POWER_LEVEL_1= 0,             //0dBm
    QL_BT_POWER_LEVEL_2,                //1dBm
    QL_BT_POWER_LEVEL_3,                //2dBm
    QL_BT_POWER_LEVEL_4,                //3dBm
    QL_BT_POWER_LEVEL_5,                //4dBm
    QL_BT_POWER_LEVEL_6,                //5dBm
    QL_BT_POWER_LEVEL_7,                //6dBm
    QL_BT_POWER_LEVEL_8,                //7dBm
    QL_BT_POWER_LEVEL_9,                //8dBm
    QL_BT_POWER_LEVEL_10,               //9dBm
    QL_BT_POWER_LEVEL_11,               //10dBm
...
*
*****************************************************************/
ql_errcode_bt_e ql_ble_exchange_mtu(unsigned int conn_id, unsigned int mtu);
...
/*****************************************************************
* Function: ql_bt_firmware_update
*
* Description:
*   升级蓝牙固件
*   注意：若需要在app侧调用，需要屏蔽app_start_8850.c里的接口
*
* Return:ql_errcode_bt_e
******************************************************************/
ql_errcode_bt_e ql_bt_firmware_update(void);

/*****************************************************************
* Function: ql_bt_power_ctl
*
* Description:
*   设置蓝牙 br edr ble 发射功率，注意：使用此接口可能会影响功耗和蓝牙功能稳定性。
*   未经全面测试，请谨慎使用
* Parameters:
*   ql_bt_power_type_e     
*   ql_bt_power_level_e
