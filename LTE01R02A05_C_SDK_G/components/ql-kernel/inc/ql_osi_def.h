...
//usb ccid
    QUEC_USB_CCID_HANDLER_START = 2007|(QL_COMPONENT_BSP_USB<<16),
...
//ble
    ...
    QUEC_BT_AVRCP_PLAY_STATE_START_IND,                                                 //bt avrcp state start callback
    QUEC_BT_AVRCP_PLAY_STATE_STOP_IND,                                                  //bt avrcp state stop callback
...
//wifiscan
	...
	QUEC_WIFISCAN_EVENT_STOP        = 3 | (QL_COMPONENT_BSP_WIFISCAN << 16),
