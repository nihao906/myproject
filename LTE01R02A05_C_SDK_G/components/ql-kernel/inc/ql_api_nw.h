...
typedef struct
{
	...
	uint16_t ta;                            //Timing Advance, RANGE: 0-63. (65535 indicates information is not present)
...
typedef struct
{
	...
	char mnc_len;
	char RX_dBm;                            //Received power
	uint16_t ta;                            //Timing Advance, RANGE: 0-1282. (65535 indicates information is not present)
