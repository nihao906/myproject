...
//codec audio
#if defined(CONFIG_QL_PROJECT_DEF_EG700G)
#define QUEC_PIN_PCM_CLK           QUEC_PIN_NONE
#define QUEC_PIN_PCM_SYNC          QUEC_PIN_NONE
#define QUEC_PIN_PCM_DIN           QUEC_PIN_NONE
#define QUEC_PIN_PCM_DOUT          QUEC_PIN_NONE
#else
#define QUEC_PIN_PCM_CLK           QUEC_PIN_DNAME_I2S1_BCK
#define QUEC_PIN_PCM_SYNC          QUEC_PIN_DNAME_I2S1_LRCK
#define QUEC_PIN_PCM_DIN           QUEC_PIN_DNAME_I2S_SDAT_I
#define QUEC_PIN_PCM_DOUT          QUEC_PIN_DNAME_I2S1_SDAT_O
#endif
...
#define QUEC_PIN_NET_STATUS_GPIO_FUNC   0x0
