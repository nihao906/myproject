...
/*======================================================================================
备注:SPI6 PORT其实是一个6线SPI控制器复用到不同的pin脚上，所以不能同时复用。
...
Note: SPI6 PORT is actually a 6-wire SPI controller multiplexed to different pin pins, so it cannot be multiplexed at the same time.
      For example, by default, pins corresponding to QL_BOOT_SPI_PORT_1 in EC200 are multiplexed into 6-line SPI functions.
      If you want to switch to QL_BOOT_SPI_PORT_2, the corresponding pin is multiplexed into 6-line SPI function.
      You need to reuse the corresponding pins of QL_BOOT_SPI_PORT_1 into other functions (such as gpio, etc.),
      and then reuse the corresponding pins of QL_BOOT_SPI_PORT_2 into 6-line SPI functions.
=======================================================================================*/
