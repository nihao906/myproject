...
+QDOWNLOAD, quec_exec_qdownload_cmd,			0
...
/********************** AC ***********************/
#if defined(__QUEC_OEM_VER_AC__)
+CSTT,      at_tcpip_ac_cstt_cmd_func,          0
+CIICR,     at_tcpip_ac_ciicr_cmd_func,         0
+CIPSHUT,   at_tcpip_ac_cipshut_cmd_func,       0
+CIFSR,     at_tcpip_ac_cifsr_cmd_func,         0
+CIPMUX,    at_tcpip_ac_cipmux_cmd_func,        0
+CIPSTART,  at_tcpip_ac_cipstart_cmd_func,      0
+CIPSEND,   at_tcpip_ac_cipsend_cmd_func,       0
+CIPCLOSE,  at_tcpip_ac_cipclose_cmd_func,      0
#endif
...
#endif
#if defined(__QUEC_OEM_VER_AC__)
+HTTPINIT,       at_http_ac_qhttpinit_cmd_func,    0
+HTTPTERM,       at_http_ac_qhttpterm_cmd_func,    0
+HTTPPARA,       at_http_ac_qhttppara_cmd_func,    0
+HTTPDATA,	     at_http_ac_qhttpdata_cmd_func,    0
+HTTPACTION,     at_http_ac_qhttpaction_cmd_func,  0
+HTTPREAD,       at_http_ac_qhttpread_cmd_func,    0
#endif
...
#endif /*CONFIG_QUEC_PROJECT_FEATURE_MQTT*/

#if defined(__QUEC_OEM_VER_OPC__) && defined(CONFIG_QUEC_PROJECT_FEATURE_UNIOT_IDENTITY)
+UNIKEYINFOM,		quec_uniot_unikeyinfom_atcmd_func,		0
#endif /*__QUEC_OEM_VER_OPC__*/
...
//********************** ctsreg at cmd ***********************/
#if defined(__QUEC_OEM_VER_OPC__) && defined(CONFIG_QUEC_PROJECT_FEATURE_CTSREG_AT)
...
//********************** lwm2m at cmd ***********************/
#if defined(__QUEC_OEM_VER_OPC__) && defined(CONFIG_QUEC_PROJECT_FEATURE_LWM2M_AT)
+QLWCONFIG,		dsat_lwm2m_exec_qlwconfig_cmd,		0
...
//#ifdef QUEC_LWM2M_EXTEND_AT_FEATURE
+QLWADDOBJ,		dsat_lwm2m_exec_qlwaddobj_cmd, 		0
+QLWDELOBJ,		dsat_lwm2m_exec_qlwdelobj_cmd, 		0
+QLWRDRSP, 		dsat_lwm2m_exec_qlwrdrsp_cmd,		0
+QLWWRRSP,		dsat_lwm2m_exec_qlwwrrsp_cmd,		0
+QLWEXERSP,		dsat_lwm2m_exec_qlwexersp_cmd,		0
+QLWOBSRSP,		dsat_lwm2m_exec_qlwobsrsp_cmd,		0
+QLWNOTIFY, 	dsat_lwm2m_exec_qlwnotify_cmd,		0
+ODIS, 			dsat_lwm2m_exec_odis_cmd,			0
+QODIS, 		dsat_lwm2m_exec_odis_cmd,			0
+QLWTEST, 		dsat_lwm2m_exec_qlwtest_cmd,		0
//#endif
...
//#endif
+QLWSTATUS,		dsat_lwm2m_exec_qlwstat_cmd,		0
+QLWRD, 	    dsat_lwm2m_exec_qlwrd_cmd,			0
+QLWRECOVER, 	dsat_lwm2m_exec_qlwrecover_cmd,		0
#endif
#if defined(__QUEC_OEM_VER_YW__)
+DATA,			at_yuwell_data_cmd_func,		0
+RDATA,			at_yuwell_rdata_cmd_func,		0
+YWSTATE,		at_yuwell_state_cmd_func, 		0
+YWURL,			at_yuwell_set_url_cmd_func,		0
#endif
#if defined(__QUEC_OEM_VER_BAX__)
+IMSI,          at_yuwell_imsi_cmd_func,        0
$M2MRESET,      at_yuwell_reset_cmd_func,       0
$M2MSN,         at_yuwell_sn_cmd_func,          0
#endif
...
#else
+GPIO_SET,	quec_exec_qgpiow_cmd,				0
#endif
...
+QVPWM,     quec_exec_virtualpwm_cmd,           0
  ...
  || (defined CONFIG_QUEC_PROJECT_FEATURE_SDMMC2) || (defined CONFIG_QUEC_PROJECT_FEATURE_EMMC2))
...
+QCELLSELECTCFG, quec_exec_qcellselect_cfg_cmd, 0
#ifndef CONFIG_QL_OPEN_EXPORT_PKG
...
#endif
#ifdef __QUEC_OEM_VER_BAX__
+WSLQ,      quec_exec_wslq_cmd,                 0
#endif
#endif
#endif
#endif
...
#ifndef CONFIG_8850BM_C1 //2M Flash项目上 只支持查空间 查文件 删文件
...
+QBTSVER,       quec_exec_bt_ver_cmd,           0
+QBTBSVER,      quec_exec_bt_backup_ver_cmd,    0
+QBTPT,         quec_exec_bt_bt_passthrough_cmd, 0
#endif
...
+QBTADVBDATA,   quec_exec_bt_exp_adv_data_cmd,  0   //BT5.0协议      
...
+QBTGATAUTHOR,  quec_exec_bt_gatt_auth_cmd,     0

+QBTLESMPCFG,   quec_exec_ble_smp_cfg_cmd,              0
+QBTLESMPS,     quec_exec_ble_smp_start_paring_cmd,     0
+QBTLESMPC,     quec_exec_ble_smp_user_confirm_cmd,     0
+QBTLESMPDEV,   quec_exec_ble_smp_get_dev_cmd,          0
...
+QGPSCFG, 	    quec_exec_qgpscfg_cmd,		        0
+QGPSDEL,       quec_exec_qgpsdel_cmd,			    0
+QGPS,	        quec_exec_qgps_cmd,		            0
+QGPSEND, 		quec_exec_qgpsend_cmd,		        0
+QGPSLOC, 		quec_exec_qgpsloc_cmd,    		    0
+QGPSGNMEA,		quec_exec_qgpsgnmea_cmd,            0
+QAGPS,         quec_exec_qagps_cmd,                0
+QGPSINFO,      quec_exec_qgpsinfo_cmd,             0
...
+QAGPSCFG,      quec_exec_qagpscfg_cmd,             0
#ifdef CONFIG_QUEC_PROJECT_FEATURE_HD_GNSS
+QGPSDEBUG,     quec_exec_qgpsdebug_cmd,            0
+QGPSPOWER,     quec_exec_qgpspower_cmd,            0
#endif
...
#ifdef __QUEC_OEM_VER_AC__ 
+AUTH,          quec_exec_auth_cmd,             0
+AUTHACT,       quec_exec_authact_cmd,          0
#endif
