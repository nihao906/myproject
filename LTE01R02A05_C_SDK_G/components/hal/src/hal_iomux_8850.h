...
#define PAD_FRC_TRI_STATE(cfg) cfg.b.slp_oe = 0, cfg.b.slp_ie = 0, cfg.b.slp_wpdo = 0, cfg.b.slp_wpu = 0, \
                               cfg.b.wpdo = 0, cfg.b.wpu = 0, cfg.b.se = 0, cfg.b.wpus = 0
// Refer to iomux.h
typedef union {
    uint32_t v;
    struct
 ...
 */
void setPadTriStateSingle(uint32_t n)
{
    volatile uint32_t *iomux_reg = (volatile uint32_t *)hwp_iomux + n / 4;
    REG_IOMUX_PAD_IO_CFG_T cfg = {*iomux_reg};
