...
#if 0
    /*
    If you want the bt chip upgrade process to be handled by the app, you can use the API before bt start. 
    Note, that you need to Remove the function in the app_start_8850.c.
     */ 
    ret = ql_bt_firmware_update();
    if (ret != QL_BT_SUCCESS)
    {
        QL_A2DP_AVRCP_DEMO_LOG("update err");
