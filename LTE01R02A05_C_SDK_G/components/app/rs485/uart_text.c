...
#define QL_CUR_UART_TX_PIN      QL_UART2_TX_PIN
#define QL_CUR_UART_TX_FUNC     QL_UART2_TX_FUNC
#define QL_CUR_UART_RX_PIN      QL_UART2_RX_PIN
#define QL_CUR_UART_RX_FUNC     QL_UART2_RX_FUNC
/*===========================================================================
 * Variate
 ===========================================================================*/
...
void ql_uart_text_cb(uint32 ind_type, ql_uart_port_number_e port, uint32 size)
{
...
static void ql_uart_demo_thread(void *param)
{
	...
	************************************************************/
	...
	if(QL_UART_SUCCESS == ret)
	{
	    ret = ql_uart_register_cb(QL_CUR_UART_PORT, ql_uart_text_cb);
	    QL_UART_DEMO_LOG("ret: 0x%x", ret);
