...
/* 屏幕尺寸 */
#define MONITOR_HOR_RES 480 // 480 // 800 // 宽
#define MONITOR_VER_RES 320 // 320 // 600 // 高
 ...
 *  Parallel port
 *-----------------*/
#define LV_DRV_DISP_PAR_CS(val) /*par_cs_set(val)*/ /*Set the Parallel port's Chip select to \
                                                       'val'*/
#define LV_DRV_DISP_PAR_SLOW /*par_slow()*/ /*Set low speed on the parallel port*/
#define LV_DRV_DISP_PAR_FAST /*par_fast()*/ /*Set high speed on the parallel port*/
#define LV_DRV_DISP_PAR_WR_WORD(data) /*par_wr(data)*/ /*Write a word to the parallel port*/
#define LV_DRV_DISP_PAR_WR_ARRAY( \
    adr, n) /*par_wr_mem(adr,n)*/ /*Write 'n' bytes to Parallel ports from 'adr'*/
...
#define SHARP_MIP_REV_BYTE(b) /*((uint8_t) __REV(__RBIT(b)))*/ /*Architecture / compiler dependent \
...
#define EVDEV_CALIBRATE                                                                         \
  0 /*Scale and offset the touchscreen coordinates by using maximum and minimum values for each \
       axis*/
