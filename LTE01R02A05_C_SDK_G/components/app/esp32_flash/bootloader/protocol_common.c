...
#define LOGI(msg, ...)          QL_LOG(QL_GPIODEMO_LOG_LEVEL, "protocol_common", msg, ##__VA_ARGS__)
...
void log_loader_internal_error(error_code_t error)
{
    ...
    switch (error) {
    case INVALID_CRC:     LOGI("INVALID_CRC"); break;
    case INVALID_COMMAND: LOGI("INVALID_COMMAND"); break;
    case COMMAND_FAILED:  LOGI("COMMAND_FAILED"); break;
    case FLASH_WRITE_ERR: LOGI("FLASH_WRITE_ERR"); break;
    case FLASH_READ_ERR:  LOGI("FLASH_READ_ERR"); break;
    case READ_LENGTH_ERR: LOGI("READ_LENGTH_ERR"); break;
    case DEFLATE_ERROR:   LOGI("DEFLATE_ERROR"); break;
    default:              LOGI("UNKNOWN ERROR"); break;
    }
}
